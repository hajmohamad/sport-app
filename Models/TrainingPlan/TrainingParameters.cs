...
public class TrainingGoalParameter
{
    ...
    public double EpocPercent { get; set; }
}
    ...
    {
        {
            ...
            new TrainingGoalParameter
                { RestBetweenSetsSec = 60, RestBetweenMovesSec = 75, TimePerRepSec = 4, EpocPercent = 0.07 }
        },
        {
            ProgramPriority.INCREASED_ENDURANCE,
            new TrainingGoalParameter
                { RestBetweenSetsSec = 35, RestBetweenMovesSec = 45, TimePerRepSec = 2, EpocPercent = 0.04 }
        },
        {
            ProgramPriority.RECOVERY,
            new TrainingGoalParameter
                { RestBetweenSetsSec = 110, RestBetweenMovesSec = 135, TimePerRepSec = 3, EpocPercent = 0.02 }
        },
        {
            ProgramPriority.LOSS_WEIGHT,
            new TrainingGoalParameter
                { RestBetweenSetsSec = 35, RestBetweenMovesSec = 45, TimePerRepSec = 2.5, EpocPercent = 0.08 }
        },
        {
            ProgramPriority.INCREASED_AGILITY,
            new TrainingGoalParameter
                { RestBetweenSetsSec = 120, RestBetweenMovesSec = 150, TimePerRepSec = 1.5, EpocPercent = 0.05 }
        },
        {
            ProgramPriority.INCREASE_STRENGTH,
            new TrainingGoalParameter
                { RestBetweenSetsSec = 145, RestBetweenMovesSec = 180, TimePerRepSec = 3.5, EpocPercent = 0.06 }
        }
    };
