...
public interface IBuyProgramFromApplications
{
    ...
    public Task<ApiResponse> BuyCoachingService(string phoneNumber,int coachingServiceId, CheckoutDiscountRequestDto? checkoutDiscountRequestDto);
    public Task<ApiResponse> PreviewCheckout(string phoneNumber,int coachingServiceId, CheckoutDiscountRequestDto? checkoutDiscountRequestDto);
